...
import com.example.swimfo.Teacher.coteacher.EditCoTeacher;
...
public class CoTeacherListAdapter extends RecyclerView.Adapter<CoTeacherListAdapter.MyViewHolder> {
    ...
    public CoTeacherListAdapter(Context context, ArrayList<CoTeacherListModel>list) {
    ...
    public MyViewHolder onCreateViewHolder( ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_coteacher,parent,false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder( MyViewHolder holder, int position) {
        CoTeacherListModel studentModel = list.get(position);
        ...
        holder.remove.setOnClickListener(v -> {
            ...
            //set message
            builder.setMessage("Are you sure you want to this teacher");
            //positive yes
            builder.setPositiveButton("YES", (dialog, which) -> {
                //remove section subject
                String idNumberToRemove = list.get(position).getUid(); // The ID number you want to match

                DatabaseReference studentsRef = FirebaseDatabase.getInstance().getReference("coteacherlist");
...
// Query for the matching records based on the ID number
        ...
        holder.edit.setOnClickListener(v -> {
            Intent intent = new Intent(context, EditCoTeacher.class);
