...
public class AddCoTeacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.teacher_coteacher_activity_add_co_teacher);
...
//                }
                ...
                Toast.makeText(getApplicationContext(),"Please Select Image and fill up ",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void createUserWithProfilePicture(Uri imageUri, String name, String email, String password, String section, String sectionId) {
        ...
        StorageReference imageRef = storageReference.child("coteacherprofilePictures/" + randomKey + "." + getFileExtension(imageUri));
                                        ...
                                        user.updateProfile(profileUpdates)
                                                .addOnCompleteListener(updateTask -> {
                                                    ...
                                                    if (updateTask.isSuccessful()) {
                                                        ...
                                                        DatabaseReference studentRef = FirebaseDatabase.getInstance().getReference("coteacherlist");
